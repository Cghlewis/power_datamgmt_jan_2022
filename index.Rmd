...
t1_toca1 <- c(1,2,3,3,4)
t1_toca2 <- c(1,2,3,4,5)
t2_toca1v1 <- c(1,3,NA,4,4)
t2_toca2 <- c(1,3,5,5,5)

df <- data.frame(pid, cohort, treatment, t1_toca1, t1_toca2, t2_toca1v1, t2_toca2)
...
* Also consider variables we are assigning/deriving:
  + Participant IDs
  + Time variables (year, time)
  + Randomization blocks (cohort)
  + Composite scores
